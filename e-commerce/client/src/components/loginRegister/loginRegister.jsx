...
export function LoginRegister() {
  ...
  const buttonClassRegister = `${styles.button} ${
  ...
  return (
    <div className={styles.loginRegisterContainer}>
      <div className={styles.sidebar}>
        <button onClick={handleLoginClick} className={buttonClassLogin}>
          Iniciar Sesión
        </button>
        <button onClick={handleSignup} className={buttonClassRegister}>
          Registrarse
        </button>
